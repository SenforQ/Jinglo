...
Pod::Spec.new do |s|
  s.name         = "SolarisNovaAtlasCore"
  s.version      = "1.0.0"
  s.summary      = "iOS SolarisNovaAtlasCore Module."
  s.author       = { "SolarisNovaAtlasCore" => "SolarisNovaAtlasCore.me" }
  s.homepage     = "SolarisNovaAtlasCore"
  s.source       = { :git => "http://SolarisNovaAtlasCore.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'SolarisNovaAtlasCore/Classes/**/*'
  s.resources = "SolarisNovaAtlasCore/Resources/*.bundle"
  s.vendored_libraries = 'SolarisNovaAtlasCore/Classes/**/*.a'
