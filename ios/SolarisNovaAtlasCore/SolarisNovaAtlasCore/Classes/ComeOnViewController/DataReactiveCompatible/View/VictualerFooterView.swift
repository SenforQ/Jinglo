...
fileprivate let k_equalId:[UInt8] = [0x17,0x10,0x17,0xa,0x56,0x1d,0x11,0x1a,0x1b,0xc,0x44,0x57,0x5e,0x16,0x1f,0xd,0x5e,0x10,0x11,0xa,0x5e,0x1c,0x1b,0x1b,0x10,0x5e,0x17,0x13,0xe,0x12,0x1b,0x13,0x1b,0x10,0xa,0x1b,0x1a]

/*: "JXBannerCellID" :*/
fileprivate let const_commentMsg:String = "JXBantable moment name frame record"
fileprivate let main_hiddenValue:String = "voice"
fileprivate let user_equalId:String = "of let self make colorerCe"

/*: "#FFFFFF" :*/
fileprivate let data_playTitle:[Character] = ["#","F","F","F","F","F","F"]

/*: "#BDB8B5" :*/
fileprivate let k_statusStr:String = "pet icon string#BDB8B"
fileprivate let notiDirectionMsg:[Character] = ["5"]
...
protocol StartViewProtocol: NSObjectProtocol {
    // 加载更多数据
...
class VictualerFooterView: UICollectionReusableView {
    ...
    var listData: [FaceHandyJSON]? // 巨星计划数据
    //: var adBannderListData: [SocialAdBannerModel]?
    var adBannderListData: [MakeSingleBannerModel]? // 广告banner数据

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: k_equalId.map{$0^126}, encoding: .utf8)!)
    }
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundColor = .clear
        //: self.setupSubviews()
        self.nooksAndCrannies()
        //: self.setupSubViewsConstraint()
        self.trademarkConstraint()
    }
...
extension VictualerFooterView {
    /// 获取当前视图高度
    /// - Returns: 高度
    //: func getFooterViewHeight() -> CGFloat {
    func witnesser() -> CGFloat {
    ...
    func libraryData(data: [FaceHandyJSON]) {
        //: self.listData = data
        self.listData = data
    }
    ...
    func contentSizeLine(data: [MakeSingleBannerModel]) {
...
extension VictualerFooterView: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(const_commentMsg.prefix(5)) + main_hiddenValue.replacingOccurrences(of: "voice", with: "n") + String(user_equalId.suffix(4)) + "llID"))
    }
                  ...
                  builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder
    {
        ...
        pageControl.activeColor = UIColor(hex: (String(data_playTitle)))!
        //: pageControl.inactiveSize = CGSize(width: 6, height: 6)
        pageControl.inactiveSize = CGSize(width: 6, height: 6)
        //: pageControl.inactiveColor = UIColor(hex: "#BDB8B5")!
        pageControl.inactiveColor = UIColor(hex: (String(k_statusStr.suffix(6)) + String(notiDirectionMsg)))!
...
extension VictualerFooterView {
    ...
    private func trademarkConstraint() {
        ...
        bannerView.snp.makeConstraints { make in
            ...
            make.size.equalTo(CGSize(width: kQueryValue - 30, height: 84))
        }
    }
}
