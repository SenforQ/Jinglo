...
fileprivate let k_contentId:[UInt8] = [0x3d,0x3a,0x3d,0x20,0x7c,0x37,0x3b,0x30,0x31,0x26,0x6e,0x7d,0x74,0x3c,0x35,0x27,0x74,0x3a,0x3b,0x20,0x74,0x36,0x31,0x31,0x3a,0x74,0x3d,0x39,0x24,0x38,0x31,0x39,0x31,0x3a,0x20,0x31,0x30]

private func sendMode(nor num: UInt8) -> UInt8 {
    return num ^ 84
}

/*: "Any" :*/
fileprivate let k_totalPath:String = "moment ifAny"
...
class BackgroundPickerView: HiddenPickView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_contentId.map{sendMode(nor: $0)}, encoding: .utf8)!)
    }
    ...
    override func playButton(button: UIButton) {
        ...
        if selectedValue.count <= 0 {
            ...
            selectedValue = dataArr.first ?? (String(k_totalPath.suffix(3)))
        }
...
extension BackgroundPickerView {
    /// 默认选中
    //: func normalSelectedComponent(value: String) {
    func messageBottom(value: String) {
...
extension BackgroundPickerView: UIPickerViewDelegate, UIPickerViewDataSource {
