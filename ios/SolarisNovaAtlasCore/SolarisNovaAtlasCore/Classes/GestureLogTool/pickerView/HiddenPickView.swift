...
fileprivate let dataBackgroundStateStr:[UInt8] = [0xad,0xaa,0xad,0xb0,0xec,0xa7,0xab,0xa0,0xa1,0xb6,0xfe,0xed,0xe4,0xac,0xa5,0xb7,0xe4,0xaa,0xab,0xb0,0xe4,0xa6,0xa1,0xa1,0xaa,0xe4,0xad,0xa9,0xb4,0xa8,0xa1,0xa9,0xa1,0xaa,0xb0,0xa1,0xa0]

private func kitFilter(put num: UInt8) -> UInt8 {
    return num ^ 196
}

/*: "Cancel" :*/
fileprivate let data_textPath:String = "model path make ifCancel"

/*: "Sure" :*/
fileprivate let showColorPath:[Character] = ["S","u","r","e"]
...
class HiddenPickView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataBackgroundStateStr.map{kitFilter(put: $0)}, encoding: .utf8)!)
    }

    //: private func setupView() {
    private func georgiaHomeBoy() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(addMenu))
        ...
        cancelButton.setTitle((String(data_textPath.suffix(6))).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(nonsolidColour(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(showColorPath)).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(playButton(button:)), for: .touchUpInside)
    ...
    @objc func nonsolidColour(button _: UIButton) {
        //: dismissView()
        addMenu()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func playButton(button _: UIButton) {
        //: dismissView()
        addMenu()
    }
