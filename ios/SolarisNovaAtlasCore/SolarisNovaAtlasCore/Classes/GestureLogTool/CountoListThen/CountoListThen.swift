...
/*: / :*/
fileprivate let k_emptyName:String = "touch"

/*: "\n" :*/
fileprivate let show_topPathMessage:[Character] = ["\n"]
...
class CountoListThen: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        barroomTo(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        barroomTo(placeholder: nil, placeholderColor: nil)
    }
}
...
extension CountoListThen {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func barroomTo(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(CapLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(CapLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-CapLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: PhotoContainerInset().top, left: PhotoContainerInset().left, bottom: PhotoContainerInset().bottom, right: PhotoContainerInset().right)
...
extension CountoListThen: UITextViewDelegate {
