...
fileprivate let main_readerText:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c","o"]
fileprivate let show_hiddenId:[Character] = ["n","t","i","n","u","e"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let user_textEqualFormat:[UInt8] = [0x7a,0x7d,0x7a,0x67,0x3b,0x70,0x7c,0x77,0x76,0x61,0x29,0x3a,0x33,0x7b,0x72,0x60,0x33,0x7d,0x7c,0x67,0x33,0x71,0x76,0x76,0x7d,0x33,0x7a,0x7e,0x63,0x7f,0x76,0x7e,0x76,0x7d,0x67,0x76,0x77]

private func managerLog(name num: UInt8) -> UInt8 {
    return num ^ 19
}
...
class EqualRangeView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(pushMatch), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(printMedia), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: CurtilageAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(main_readerText) + String(show_hiddenId))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_textEqualFormat.map{managerLog(name: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func atDoing(title: String, isTouch: Bool) {
