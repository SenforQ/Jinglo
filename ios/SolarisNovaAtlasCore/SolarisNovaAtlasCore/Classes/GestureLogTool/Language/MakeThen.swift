...
@objcMembers open class MakeThen: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = MakeThen()
    //: private(set) var currLanguage: String = PublisherReactiveCompatible.getSystemLangCode()
    private(set) var currLanguage: String = PublisherReactiveCompatible.sizeEqual()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func imageChange(_ language: String) {
...
extension String {
    ...
    public func viewfinder(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = SkullSessionReactiveCompatible.default.languagePath
