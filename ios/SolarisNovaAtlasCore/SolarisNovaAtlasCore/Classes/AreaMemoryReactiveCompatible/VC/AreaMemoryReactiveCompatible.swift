...
fileprivate let mainTrackPhoneFormat:String = "AreaColive length lab name"
fileprivate let noti_groupId:String = "type frame allow size indeChoi"

/*: "init(coder:) has not been implemented" :*/
fileprivate let userTitleData:[UInt8] = [0xde,0xd9,0xde,0xc3,0x9f,0xd4,0xd8,0xd3,0xd2,0xc5,0x8d,0x9e,0x97,0xdf,0xd6,0xc4,0x97,0xd9,0xd8,0xc3,0x97,0xd5,0xd2,0xd2,0xd9,0x97,0xde,0xda,0xc7,0xdb,0xd2,0xda,0xd2,0xd9,0xc3,0xd2,0xd3]

/*: "Select Country Code" :*/
fileprivate let showButtonMessage:String = "start from imageSelect C"
fileprivate let data_inputKey:String = "currentuntr"

/*: "#F4F6FA" :*/
fileprivate let data_tableUrl:[Character] = ["#","F","4","F","6","F","A"]
...
// __CLOSE_PRINT__
//
//  AreaMemoryReactiveCompatible.swift
//  AbroadTalking
//
...
class AreaMemoryReactiveCompatible: SizeViewController {
    //: public var backCountryCode: ((TalkingAreaModel) -> Void)?
    public var backCountryCode: ((RecordTopMeasurable) -> Void)?

    //: private let TalkingAreaCodeChoiceCellID = "AreaCodeChoiceCellID"
    private let TalkingAreaCodeChoiceCellID = (String(mainTrackPhoneFormat.prefix(6)) + String(noti_groupId.suffix(6)) + "ceCellID")
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userTitleData.map{$0^183}, encoding: .utf8)!)
    }
    ...
    override func viewDidLoad() {
        ...
        self.title = (String(showButtonMessage.suffix(8)) + data_inputKey.replacingOccurrences(of: "current", with: "o") + "y Code").localized
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(PowerToolThen.classForCoder(), forCellReuseIdentifier: TalkingAreaCodeChoiceCellID)
        ...
        tableView.backgroundColor = UIColor(hex: (String(data_tableUrl)))
        //: return tableView
        return tableView
        //: }()
    }()
...
extension AreaMemoryReactiveCompatible {
    ...
    private func table() {
        ...
        for areaModel: RecordTopMeasurable in arr {
        ...
        for index in 0 ..< sectionNumb {
            ...
            let sortArr = collation.sortedArray(from: tempArr, collationStringSelector: #selector(getter: RecordTopMeasurable().areaName))
...
extension AreaMemoryReactiveCompatible: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if sectionArray.count > section {
            ...
            let array: [RecordTopMeasurable] = sectionArray[section] as! [RecordTopMeasurable]
            //: return array.count
            return array.count
        }
        //: return 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: PowerToolThen = tableView.dequeueReusableCell(withIdentifier: TalkingAreaCodeChoiceCellID, for: indexPath) as! PowerToolThen
        //: let array: [TalkingAreaModel] = sectionArray[indexPath.section] as! [TalkingAreaModel]
        let array: [RecordTopMeasurable] = sectionArray[indexPath.section] as! [RecordTopMeasurable]
        //: cell.func__updateUIWithModel(areaModel: array[indexPath.row])
        cell.withModel(areaModel: array[indexPath.row])
    ...
    func tableView(_: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headView.frame = CGRect(x: 0, y: 0, width: kQueryValue, height: 30)
        ...
        label.frame = CGRect(x: 15, y: 0, width: kQueryValue - 30, height: 30)
