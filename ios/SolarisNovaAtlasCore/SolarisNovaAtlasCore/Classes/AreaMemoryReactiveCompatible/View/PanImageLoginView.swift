...
fileprivate let kContentMessage:[UInt8] = [0x5e,0x59,0x5e,0x43,0x1f,0x54,0x58,0x53,0x52,0x45,0xd,0x1e,0x17,0x5f,0x56,0x44,0x17,0x59,0x58,0x43,0x17,0x55,0x52,0x52,0x59,0x17,0x5e,0x5a,0x47,0x5b,0x52,0x5a,0x52,0x59,0x43,0x52,0x53]

private func plusShow(video num: UInt8) -> UInt8 {
    return num ^ 55
}

/*: "Enter phone number" :*/
fileprivate let app_imageValue:String = "Entertrue view main"
fileprivate let mainLogCancelName:String = "time actione number"

/*: "Enter Email Address" :*/
fileprivate let showManagerPath:[Character] = ["E"]
fileprivate let data_layerViewPeriodValue:String = "nteold"
fileprivate let k_addData:String = "import inil A"

/*: "F4F4F4" :*/
fileprivate let user_reportData:String = "back4back4back4"

/*: "America(+1)" :*/
fileprivate let dataBorderImageKey:String = "America(+edit up show"
fileprivate let user_videoName:[Character] = ["1",")"]

/*: "area_code_down_icon" :*/
fileprivate let userTagPath:[Character] = ["a","r","e","a","_","c","o","d","e","_","d"]
fileprivate let main_sharedKey:String = "own_iconvar self manager super"

/*: "BBBBBB" :*/
fileprivate let main_viewData:[Character] = ["B","B","B","B","B","B"]

/*: "btn_field_delete_icon" :*/
fileprivate let dataCancelIndexMsg:String = "btn_ficontent gender"
fileprivate let dataMakeName:[Character] = ["l"]
fileprivate let noti_contentUrl:String = "res true case viewete_"

/*: "Password" :*/
fileprivate let mainTotalName:[Character] = ["P","a","s","s","w","o","r","d"]

/*: "CCCCCC" :*/
fileprivate let showGameValue:String = "wordwordword"

/*: "or" :*/
fileprivate let notiReasonId:[Character] = ["o","r"]

/*: "F5F5F5" :*/
fileprivate let showClickLiveId:String = "Fmakemake"
fileprivate let mainUpId:[Character] = ["5"]

/*: "Next" :*/
fileprivate let noti_toolValue:String = "Nextsend else photo"

/*: "Login by password" :*/
fileprivate let data_makePath:[Character] = ["L","o","g","i","n"," ","b","y"]
fileprivate let noti_styleJumpMessage:[Character] = [" "]
fileprivate let main_inputTitle:[Character] = ["p","a","s","s","w","o","r","d"]

/*: "Login by OTP" :*/
fileprivate let appPathValue:String = "Login bm share guard"
fileprivate let noti_imageMakeName:[Character] = ["y"," ","O","T","P"]

/*: "#8C7AFF" :*/
fileprivate let user_progressStr:String = "of image new control#8C7A"
fileprivate let k_playData:[Character] = ["F","F"]

/*: "Login" :*/
fileprivate let constVideoStr:[Character] = ["L","o","g","i","n"]

/*: "Send verification" :*/
fileprivate let userManagerMakeSkinStr:String = "Sendbackground source"
fileprivate let const_userId:String = "imagefimageca"
fileprivate let data_pointMoreLeftPath:String = "tiodata"
...
class PanImageLoginView: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kContentMessage.map{plusShow(video: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(app_imageValue.prefix(5)) + " phon" + String(mainLogCancelName.suffix(8))).localized : (String(showManagerPath) + data_layerViewPeriodValue.replacingOccurrences(of: "old", with: "r") + " Ema" + String(k_addData.suffix(4)) + "ddress").localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (user_reportData.replacingOccurrences(of: "back", with: "F")))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(dataBorderImageKey.prefix(9)) + String(user_videoName))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.thoughtImageBundleSizeText(name: (String(userTagPath) + String(main_sharedKey.prefix(8))))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (user_reportData.replacingOccurrences(of: "back", with: "F")))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.clickLarge(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (String(main_viewData)))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.thoughtImageBundleSizeText(name: (String(dataCancelIndexMsg.prefix(6)) + "eld_de" + String(dataMakeName) + String(noti_contentUrl.suffix(4)) + "icon")), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(mainTotalName)).localized
        //: lab.textColor = .appTitleColor()
        lab.textColor = .toEvent()
        //: lab.font = UIFont.pingfangFont(type: .Semibold, fontSize: 17)
        lab.font = UIFont.clickLarge(type: .Semibold, fontSize: 17)
        //: lab.isHidden = true
        lab.isHidden = true
        //: return lab
        return lab
    ...
    private lazy var pwdInputView: UITextField = {
        ...
        textField.font = .clickLarge(type: .Regular, fontSize: 17)
        //: textField.textColor = .appTitleColor()
        textField.textColor = .toEvent()
        //: textField.layer.cornerRadius = 25
        textField.layer.cornerRadius = 25
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (showGameValue.replacingOccurrences(of: "word", with: "CC")))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (showClickLiveId.replacingOccurrences(of: "make", with: "5F") + String(mainUpId)))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(noti_toolValue.prefix(4))).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.readRemove(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(data_makePath) + String(noti_styleJumpMessage) + String(main_inputTitle)).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(appPathValue.prefix(7)) + String(noti_imageMakeName)).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(sender(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(user_progressStr.suffix(5)) + String(k_playData)))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension PanImageLoginView {
    ...
    @objc private func sender(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(constVideoStr)).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(noti_toolValue.prefix(4))).localized, for: .normal)
        }
    ...
    func inform() {
        ...
        commitButton.setTitle((String(userManagerMakeSkinStr.prefix(4)) + " ver" + const_userId.replacingOccurrences(of: "image", with: "i") + data_pointMoreLeftPath.replacingOccurrences(of: "data", with: "n")).localized, for: .normal)
    }
}
