...
class DirectionReactiveCompatible: UINavigationController {

    //: var tabBarType: TabBarItemType?
    var tabBarType: ListSignedNumber?
    //: var pushing = false                             
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        if viewControllers.count >= 1 {
            ...
            if viewController.navigationItem.leftBarButtonItem == nil {
                ...
                viewController.navigationItem.leftBarButtonItem = viewController.itemCurrentPopback()
            }
        }
    ...
    func constraintCell() {
        ...
        if #available(iOS 15.0, *) {
            ...
            barApp.backgroundImage = UIImage.inheritanceOf(color: UIColor.white)
            //: barApp.shadowImage = UIImage.init()
            barApp.shadowImage = UIImage.init()
            //: barApp.shadowColor = UIColor.appBgColor()
            barApp.shadowColor = UIColor.sizeColor()
            ...
            barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.toEvent(), NSAttributedString.Key.font: UIFont.clickLarge(type: .Medium, fontSize: 17)]
        ...
        //: } else {
            ...
            navigationBar.setBackgroundImage(UIImage.inheritanceOf(color: UIColor.white), for: .any, barMetrics: .default)
            ...
            navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.toEvent(), NSAttributedString.Key.font: UIFont.clickLarge(type: .Medium, fontSize: 17)]
        }
        //: UINavigationBar.appearance().tintColor = UIColor.appTitleColor()
        UINavigationBar.appearance().tintColor = UIColor.toEvent()
...
extension DirectionReactiveCompatible: UINavigationControllerDelegate {
...
extension DirectionReactiveCompatible: UIGestureRecognizerDelegate {
