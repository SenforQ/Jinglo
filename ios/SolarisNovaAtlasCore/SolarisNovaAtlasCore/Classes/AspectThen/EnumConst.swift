...
enum AuthColumnConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum SizeBidirectionalCollection: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum ParentColumnConvertible: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum HiddenHashableRepresentation: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum AppSendable: Int {
    //: case Unavailable = 0
...
enum ProviderCellType: CaseIterable {
...
enum ColorHashableRepresentation: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
