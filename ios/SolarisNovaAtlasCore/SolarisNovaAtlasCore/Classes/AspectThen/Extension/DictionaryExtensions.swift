...
extension Dictionary {
    ...
    public static func dropModel(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func requestContent(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.dropModel(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
