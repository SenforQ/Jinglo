...
class LabReactiveCompatible: UILabel {
    ...
    private func rubric() {
        ...
        layer.backgroundColor = UIColor.satisfy().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.clickLarge(type: .Medium, fontSize: 11)
