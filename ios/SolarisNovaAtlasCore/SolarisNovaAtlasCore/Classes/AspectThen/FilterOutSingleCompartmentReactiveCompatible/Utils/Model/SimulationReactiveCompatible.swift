...
// __CLOSE_PRINT__
//
//  SimulationReactiveCompatible.swift
//  AbroadTalking
//
...
//: @objcMembers public class SimulationReactiveCompatible: JSONModel {
@objcMembers public class SimulationReactiveCompatible: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = ViewKeyRepresentable.Face
...
//: @objc extension SimulationReactiveCompatible {
@objc extension SimulationReactiveCompatible {
    //: func initWith(suiteType: BeautyItemType)-> SimulationReactiveCompatible {
    func equalCard(suiteType: ViewKeyRepresentable) -> SimulationReactiveCompatible {
        //: let model = SimulationReactiveCompatible.init()
        let model = SimulationReactiveCompatible()
        //: model.beautySuite = suiteType
        model.beautySuite = suiteType
        //: model.resetBeautySuiteValueFor()
        model.resetForSuiteEigenvalueOfAmatrixComeliness()
        //: return model
        return model
    }

    //: func resetBeautySuiteValueFor() {
    func resetForSuiteEigenvalueOfAmatrixComeliness() {
