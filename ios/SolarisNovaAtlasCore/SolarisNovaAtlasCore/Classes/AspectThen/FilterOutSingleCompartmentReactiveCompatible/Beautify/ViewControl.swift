...
/*: "st_slider_thumb" :*/
fileprivate let notiCenterFormat:String = "st_smake show import"
fileprivate let main_layerMsg:String = "view color view action_thu"
fileprivate let const_borderListFormat:[Character] = ["m","b"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let constLineData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class ViewControl: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.thoughtImageBundleSizeText(name: (String(notiCenterFormat.prefix(4)) + "lider" + String(main_layerMsg.suffix(4)) + String(const_borderListFormat)))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constLineData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.clickLarge(type: .Regular, fontSize: 12)
