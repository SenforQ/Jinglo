...
/*: "Face verification" :*/
fileprivate let mainModelValueTitle:String = "Face velayer center"
fileprivate let notiContainerData:[Character] = ["r","i","f","i","c","a","t","i","o","n"]
...
class ModelViewController: SizeViewController {
    ...
    override func viewDidLoad() {
        ...
        title = (String(mainModelValueTitle.prefix(7)) + String(notiContainerData)).localized
        //: self.createUI()
        self.sessionUi()
        //: self.createUIConstraint()
        self.constraintStyle()
    }

    // MARK: - Lazy load

    //: lazy var mainView: TalkingVerificationExampleView = {
    lazy var mainView: ListExampleView = {
        //: let view = TalkingVerificationExampleView()
        let view = ListExampleView()
        //: return view
        return view
        //: }()
    }()
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = DetailViewController(photoImage: photo)
...
extension ModelViewController {
    ...
    func sessionUi() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            CustomPermissionTool.behindCell(true) { isOpen in
