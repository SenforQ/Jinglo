...
fileprivate let dataAddStr:[UInt8] = [0x49,0x4e,0x49,0x54,0x8,0x43,0x4f,0x44,0x45,0x52,0x1a,0x9,0x0,0x48,0x41,0x53,0x0,0x4e,0x4f,0x54,0x0,0x42,0x45,0x45,0x4e,0x0,0x49,0x4d,0x50,0x4c,0x45,0x4d,0x45,0x4e,0x54,0x45,0x44]

/*: "btn_me_edit" :*/
fileprivate let user_managerFormat:String = "btn_indicator var view to will"
fileprivate let main_priceMsg:[Character] = ["m","e","_","e","d","i","t"]
...
class WithReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataAddStr.map{$0^32}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.thoughtImageBundleSizeText(name: (String(user_managerFormat.prefix(4)) + String(main_priceMsg))))
...
extension WithReactiveCompatible {
    ...
    func userShow(titile: String, row: Int, isLast: Bool) {
    ...
    func straddle() {
        ...
        titleBLB.font = UIFont.clickLarge(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.clickLarge(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
