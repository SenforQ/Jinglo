...
fileprivate let const_giftStr:[UInt8] = [0x34,0x33,0x34,0x29,0x75,0x3e,0x32,0x39,0x38,0x2f,0x67,0x74,0x7d,0x35,0x3c,0x2e,0x7d,0x33,0x32,0x29,0x7d,0x3f,0x38,0x38,0x33,0x7d,0x34,0x30,0x2d,0x31,0x38,0x30,0x38,0x33,0x29,0x38,0x39]

/*: "btn_me_edit" :*/
fileprivate let kCancelFormat:String = "btn_memake image"

/*: "Add" :*/
fileprivate let notiLabelKey:[Character] = ["A","d","d"]
...
class PositionViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_giftStr.map{$0^93}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.thoughtImageBundleSizeText(name: (String(kCancelFormat.prefix(6)) + "_edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.text = (String(notiLabelKey)).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
...
extension PositionViewCell {
    ...
    func executeShowView(titile: String, iconStr: String, isShowDet: Bool) {
        //: titleBLB.text = titile
        titleBLB.text = titile
        //: iconImg.image = UIImage.BundleImageNamed(name: iconStr)
        iconImg.image = UIImage.thoughtImageBundleSizeText(name: iconStr)
