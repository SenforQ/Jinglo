...
fileprivate let noti_voiceLimitName:[UInt8] = [0xa7,0xa0,0xa7,0xba,0xe6,0xad,0xa1,0xaa,0xab,0xbc,0xf4,0xe7,0xee,0xa6,0xaf,0xbd,0xee,0xa0,0xa1,0xba,0xee,0xac,0xab,0xab,0xa0,0xee,0xa7,0xa3,0xbe,0xa2,0xab,0xa3,0xab,0xa0,0xba,0xab,0xaa]

private func nameCenter(less num: UInt8) -> UInt8 {
    return num ^ 206
}

/*: "icon_gift_placeholder" :*/
fileprivate let const_userAngleName:String = "iphasen"
fileprivate let const_transactionInfoRawTitle:String = "_placegift let mode"
fileprivate let app_playText:[Character] = ["h","o","l","d","e","r"]

/*: "Gift" :*/
fileprivate let user_rangeId:String = "Giftnot content quote by"

/*: "x%ld" :*/
fileprivate let k_imageName:String = "x%ldtable as"
...
// __CLOSE_PRINT__
//
//  FailIncidentalReusableView.swift
//  AbroadTalking
//
...
class FailIncidentalReusableView: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        self.receiveByConstraint()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: noti_voiceLimitName.map{nameCenter(less: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .loadRgba(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.thoughtImageBundleSizeText(name: (const_userAngleName.replacingOccurrences(of: "phase", with: "co") + "_gift" + String(const_transactionInfoRawTitle.prefix(6)) + String(app_playText)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(user_rangeId.prefix(4))).localized
...
extension FailIncidentalReusableView {
    //: func configGiftItemCellWithData(giftModel: TalkingUserReceivedGiftModel, _ isNewProfile: Bool) {
    func ofModel(giftModel: HouseHandyJSON, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.putBackThroughFinish(urlStr: giftModel.img)
...
extension FailIncidentalReusableView {
    ...
    private func receiveByConstraint() {
