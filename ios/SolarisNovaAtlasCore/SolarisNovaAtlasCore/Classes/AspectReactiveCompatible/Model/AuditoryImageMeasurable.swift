...
/*: "id" :*/
fileprivate let dataEqualPath:[Character] = ["i","d"]
...
struct AuditoryImageMeasurable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: GiftHandyJSON?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [FailModelType]? // 相册
    ...
    var aiExtraInfo = ColorMeasurable() // AI模型
    //: var vipSkinId = 0
...
struct GiftHandyJSON: HandyJSON {
    ...
    var list: [RequestTransformable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct RequestTransformable: HandyJSON {
...
struct FailModelType: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func sceneKeyDigitiser(compareTo: FailModelType) -> Bool {
        //: return
        return
