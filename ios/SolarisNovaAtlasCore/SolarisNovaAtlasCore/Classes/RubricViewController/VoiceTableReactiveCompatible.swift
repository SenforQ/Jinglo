...
/*: "&sr=6" :*/
fileprivate let mainReadReplyStr:String = "super let return&sr=6"
...
// __CLOSE_PRINT__
//
//  VoiceTableReactiveCompatible.swift
//  AbroadTalking
//
...
enum GestureOutputStreamable: String, CaseIterable {
...
enum DataPlumeBidirectionalCollection: String {
...
class VoiceTableReactiveCompatible: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func comeUponModel(urlType: DataPlumeBidirectionalCollection) -> String {
        //: var url = PunctuateThen.share.appConfigMode.urlH5Domain
        var url = PunctuateThen.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(PunctuateThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : PunctuateThen.share.appUserConfigMode.fullRechargePage)
            url.append(PunctuateThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : PunctuateThen.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(PunctuateThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : PunctuateThen.share.appUserConfigMode.halfRechargePage)
            url.append(PunctuateThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : PunctuateThen.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = PunctuateThen.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = PunctuateThen.share.appUserConfigMode.halfRechargePage.appending((String(mainReadReplyStr.suffix(5))))
            //: url.append(PunctuateThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(PunctuateThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
