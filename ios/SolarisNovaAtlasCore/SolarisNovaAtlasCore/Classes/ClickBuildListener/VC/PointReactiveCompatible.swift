...
class PointReactiveCompatible: SizeViewController {
    ...
    lazy var usePhotoView: RecordView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = RecordView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension PointReactiveCompatible {
    ...
    func untilStatus(modle: ViewMeasurable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==PunctuateThen.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == PunctuateThen.share.loginUserMode.sex
        }
