...
fileprivate let kAreaText:[UInt8] = [0x82,0x85,0x82,0x9f,0xc3,0x88,0x84,0x8f,0x8e,0x99,0xd1,0xc2,0xcb,0x83,0x8a,0x98,0xcb,0x85,0x84,0x9f,0xcb,0x89,0x8e,0x8e,0x85,0xcb,0x82,0x86,0x9b,0x87,0x8e,0x86,0x8e,0x85,0x9f,0x8e,0x8f]

private func bridePrice(model num: UInt8) -> UInt8 {
    return num ^ 235
}

/*: "icon_home_boy" :*/
fileprivate let userStreamBeanFormat:String = "at add itemicon_h"
fileprivate let user_pathSinceKey:[Character] = ["o","m","e","_","b","o","y"]

/*: "icon_home_girl" :*/
fileprivate let kFaceNameViewFormat:[Character] = ["i","c","o","n","_","h","o","m","e","_","g"]
fileprivate let showFileUserName:String = "IRL"

/*: "   " :*/
fileprivate let k_attributeId:String = "backgroundbackgroundbackground"
...
class BlockThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kAreaText.map{bridePrice(model: $0)}, encoding: .utf8)!)
    }
...
extension BlockThen {
    ...
    func cellType(model: SodalistSendMemberModel, type: SendCustomReflectable) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.thoughtImageBundleSizeText(name: (String(userStreamBeanFormat.suffix(6)) + String(user_pathSinceKey))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.thoughtImageBundleSizeText(name: (String(kFaceNameViewFormat) + showFileUserName.lowercased())), for: .normal)
        //: break
        //: default:
        default:
            //: break
