...
fileprivate let show_taskModelPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Full" :*/
fileprivate let dataGiftName:String = "square text view selfFull"

/*: "%@ Online" :*/
fileprivate let noti_resignStr:String = "%@ Onobject bottom key"
...
class StyleViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_taskModelPath.reversed(), encoding: .utf8)!)
    }
...
extension StyleViewCell {
    ...
    func loadUpData(model: ImageListModel) {
        //: IconBtn.setUrlImage(urlStr: model.icon)
        IconBtn.blockHalf(urlStr: model.icon)
        ...
        if model.isFull {
            ...
            numberLB.text = (String(dataGiftName.suffix(4))).localized
            //: numberLB.textColor = UIColor.msgTipsColor()
            numberLB.textColor = UIColor.satisfy()
            //: }else {
        } else {
            //: numberLB.text = "%@ Online".localizedArguments(model.num)
            numberLB.text = (String(noti_resignStr.prefix(5)) + "line").viewfinder(model.num)
            //: numberLB.textColor = .appValueDetailColor()
            numberLB.textColor = .hockeyPlayer()
        }
    }
}
