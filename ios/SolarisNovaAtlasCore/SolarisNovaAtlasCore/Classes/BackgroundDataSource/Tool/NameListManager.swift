...
/*: "App" :*/
fileprivate let constToMessage:String = "Applive path type class"

/*: "blockList_ :*/
fileprivate let const_sizeContent:String = "blockLmake return view return type"
...
class NameListManager: NSObject {
    ...
    func beyondSlideId(userId: String) {
    ...
    func liveButton(userId: String) -> Bool {
    ...
    private func touchPath() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(constToMessage.prefix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(const_sizeContent.prefix(6)) + "ist_") + "\(uid)")
        //: return filePath
        return filePath
    }
}
