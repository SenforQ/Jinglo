...
fileprivate let data_formatFlushMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class ListViewCell: UITableViewCell {
    ...
    lazy var menuImageView: UIImageView = self.modelOn()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.decisionMaker()
    ...
    var menuModel: SomebodyMenuModel? {
        //: didSet {
        didSet {
    ...
    var dropMenuStyle: StatuteContentMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_formatFlushMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private func modelOn() -> UIImageView {
    ...
    private func decisionMaker() -> UILabel {
    ...
    private func selectMore() {
        ...
        lineLayer.strokeColor = UIColor.loadRgba(230, 230, 230, 1.0).cgColor
