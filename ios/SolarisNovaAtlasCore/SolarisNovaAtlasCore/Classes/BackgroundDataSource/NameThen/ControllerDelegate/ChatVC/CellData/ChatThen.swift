...
/*: _" :*/
fileprivate let data_postTitle:String = "_"

/*: ".png" :*/
fileprivate let appTimeMsg:String = ".pngself total range model cell"
...
@objcMembers public class ChatThen: CompartmentCellData {
    ...
    override public var msgModel: SharedModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.auditoryImage(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func qibla(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(constButtonMessage)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + PunctuateThen.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + PunctuateThen.share.loginUserMode.userID + (String(appTimeMsg.prefix(4)))
        ...
        let imageData = UIImage.error(image, secure: 2 * 1024)
