...
@objcMembers class ModelType: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: SizeMeasurable?
    //: var gift: TalkingMsgGiftModel?
    var gift: CharacteristicThen?
    //: var user: TalkingMsgUserModel?
    var user: ForefrontUserModel?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: DataConverterTransformable?
...
class SizeMeasurable: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class ForefrontUserModel: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class DataConverterTransformable: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class CharacteristicThen: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
