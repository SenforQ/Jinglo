...
@property (nonatomic, strong)ContentModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)ViewModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)OfModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)TalkingMakeModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)PeregrineModel *quoteMsgInfo;

//: @property (nonatomic, strong)RequestHandyJSON *userInfoModel;
@property (nonatomic, strong)RequestHandyJSON *userInfoModel;
...
@property (nonatomic, strong) PhotoModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) PublishNameModel *video; /// 有该字段表示是视频消息
...
@property (nonatomic, strong) BridePriceModel *wantGift; /// 想要礼物
...
@interface PublishNameModel: JSONModel
...
@interface TalkingMakeModel : JSONModel
...
@interface BridePriceModel : JSONModel
...
@interface PeregrineModel : JSONModel
...
@property (nonatomic, strong) CopyModel *renderData;
