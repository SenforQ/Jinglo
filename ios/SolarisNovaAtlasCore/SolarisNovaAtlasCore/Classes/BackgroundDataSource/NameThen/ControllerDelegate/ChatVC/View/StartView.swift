...
fileprivate let userHiddenKey:[UInt8] = [0xd,0xa,0xd,0x10,0x4c,0x7,0xb,0x0,0x1,0x16,0x5e,0x4d,0x44,0xc,0x5,0x17,0x44,0xa,0xb,0x10,0x44,0x6,0x1,0x1,0xa,0x44,0xd,0x9,0x14,0x8,0x1,0x9,0x1,0xa,0x10,0x1,0x0]
...
class StartView: UIView {
    ...
    class func recordCamera(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return StartView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userHiddenKey.map{$0^100}, encoding: .utf8)!)
    }
