...
@objcMembers public class PictureCellLayout: NSObject {
    ...
    class func taro() -> PictureCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = PictureCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func tiedNumbereraction() -> PictureCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PictureCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func addAcross() -> PictureCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PictureCellLayout.init(isIncomming: false)
    ...
    class func ping() -> PictureCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = PictureCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func serverOf() -> PictureCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PictureCellLayout.init(isIncomming: false)
        //: return layout
        return layout
