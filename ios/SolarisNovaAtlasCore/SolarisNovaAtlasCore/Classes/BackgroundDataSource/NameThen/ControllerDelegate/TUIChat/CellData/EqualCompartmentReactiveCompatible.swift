...
/******************************************************************************
 *
 *  本文件声明了 EqualCompartmentReactiveCompatible 类。
...
@objc public enum StreetSmartInsetTarget: UInt {
...
@objc public enum AspectSendTotal: UInt {
...
// MARK: - EqualCompartmentReactiveCompatible

/**
 * 【模块名称】EqualCompartmentReactiveCompatible
 ...
 */
//: @objcMembers public class EqualCompartmentReactiveCompatible: TCommonCellData {
@objcMembers public class EqualCompartmentReactiveCompatible: DetailCellData {
    ...
    public var direction: AspectSendTotal = .MsgDirectionIncoming
    ...
    public var translateStatus: StreetSmartInsetTarget = .MsgTranslate_init
    ...
    public var msgModel: SharedModel = SharedModel()
    ...
    public var cellLayout: PictureCellLayout!
    ...
    public init(direction: AspectSendTotal) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.brother()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = PictureCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = PictureCellLayout(isIncomming: false)
    ...
    /// 内容大小
    /// 返回一个气泡内容的视图大小。
    //: public func accumulationOn() -> CGSize {
    public func accumulationOn() -> CGSize {
        //: return CGSize.zero
        return CGSize.zero
    }
    ...
    public override func transaction(_ width: CGFloat) -> CGFloat {
