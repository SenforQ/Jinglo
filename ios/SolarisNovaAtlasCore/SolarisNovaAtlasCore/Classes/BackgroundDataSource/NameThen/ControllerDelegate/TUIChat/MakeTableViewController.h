 ...
 *
 *  ToDelegate 协议和 MakeTableViewController 类。
 *  MakeTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 MakeTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class MakeTableViewController;
//: @class ToolView;
@class ToolView;
//: @class EqualCompartmentReactiveCompatible;
@class EqualCompartmentReactiveCompatible;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
- (void)cans:(MakeTableViewController *)controller;
...
- (void)strips:(MakeTableViewController *)controller;
...
- (BOOL)photo:(MakeTableViewController *)controller size:(UIView *)view;
 ...
 */
//: - (EqualCompartmentReactiveCompatible *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (EqualCompartmentReactiveCompatible *)price:(MakeTableViewController *)controller everyIndicator:(V2TIMMessage *)data;
 ...
 */
//: - (ToolView *)messageController:(TUIMessageController *)controller onShowMessageData:(EqualCompartmentReactiveCompatible *)data;
- (ToolView *)draw:(MakeTableViewController *)controller local:(EqualCompartmentReactiveCompatible *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(ToolView *)cell;
- (void)cipherOrigin:(MakeTableViewController *)controller managerPosition:(ToolView *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(ToolView *)cell;
- (void)action:(MakeTableViewController *)controller latchkey:(ToolView *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(EqualCompartmentReactiveCompatible *)data;
- (void)overSession:(MakeTableViewController *)controller fromWith:(NSInteger)menuType telegramData:(EqualCompartmentReactiveCompatible *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(ToolView *)cell;
- (void)haywire:(MakeTableViewController *)controller model:(ToolView *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(EqualCompartmentReactiveCompatible *)cellData;
- (void)nonnegative:(MakeTableViewController *)controller auditoryImage:(EqualCompartmentReactiveCompatible *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(EqualCompartmentReactiveCompatible *)cellData;
- (void)with:(MakeTableViewController *)controller start:(EqualCompartmentReactiveCompatible *)cellData;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<EqualCompartmentReactiveCompatible *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成EqualCompartmentReactiveCompatible
 */
