...
fileprivate let app_sharedTitle:[UInt8] = [0xd6,0xd1,0xd6,0xcb,0x97,0xdc,0xd0,0xdb,0xda,0xcd,0x85,0x96,0x9f,0xd7,0xde,0xcc,0x9f,0xd1,0xd0,0xcb,0x9f,0xdd,0xda,0xda,0xd1,0x9f,0xd6,0xd2,0xcf,0xd3,0xda,0xd2,0xda,0xd1,0xcb,0xda,0xdb]

private func inputColor(vertical num: UInt8) -> UInt8 {
    return num ^ 191
}
...
class LogLivePlayListener: ShortListThen {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_sharedTitle.map{inputColor(vertical: $0)}, encoding: .utf8)!)
    }
...
extension LogLivePlayListener {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func neolith(liveUrl: String) {
...
extension LogLivePlayListener: TXLivePlayListener {
