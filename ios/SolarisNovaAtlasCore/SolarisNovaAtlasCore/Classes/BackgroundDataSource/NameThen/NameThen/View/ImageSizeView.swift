...
fileprivate let dataViewWithKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_live_nor" :*/
fileprivate let noti_applicationName:String = "btn_lmain var string"

/*: "Live" :*/
fileprivate let const_formatRecordValue:String = "Livetrue self scale data"

/*: "btn_party_nor" :*/
fileprivate let app_pathId:[Character] = ["b","t","n","_","p","a"]
fileprivate let mainContentMessage:String = "conversation selection large caserty_nor"

/*: "Party" :*/
fileprivate let k_containerName:String = "Partylayer mode render var cell"
...
class ImageSizeView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataViewWithKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var liveBtn: UIButton = {
        ...
        btn.setImage(UIImage.thoughtImageBundleSizeText(name: (String(noti_applicationName.prefix(5)) + "ive_nor")), for: .normal)
        //: btn.addTarget(self, action: #selector(liveButtonAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(shouldAction), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var liveLab: UILabel = {
        ...
        lab.text = (String(const_formatRecordValue.prefix(4))).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var partyBtn: UIButton = {
        ...
        btn.setImage(UIImage.thoughtImageBundleSizeText(name: (String(app_pathId) + String(mainContentMessage.suffix(7)))), for: .normal)
        //: btn.addTarget(self, action: #selector(partyButtonAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(lightGreenFederalPartyEqualDeed), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var partyLab: UILabel = {
        ...
        lab.text = (String(k_containerName.prefix(5))).localized
        //: return lab
        return lab
        //: }()
    }()
...
extension ImageSizeView {
    /// 展示视图
    //: func show() {
    func memoryImageStart() {
    ...
    @objc private func shouldAction() {
        //: dismiss()
        each()
    ...
    @objc private func lightGreenFederalPartyEqualDeed() {
        //: dismiss()
        each()
        //: RangePushManager.share.func_pushToVoiceRoomVC()
        RangePushManager.share.interval()
    }
}
...
extension ImageSizeView {
    ...
    private func cast() {
        ...
        backView.snp.makeConstraints { make in
            ...
            make.height.equalTo(163 + k_netId)
        }
        ...
        liveLab.snp.makeConstraints { make in
            ...
            make.width.equalTo(kQueryValue / 2)
        }
