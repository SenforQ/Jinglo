...
fileprivate let showWithFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_tc_warn" :*/
fileprivate let appToStarValue:[Character] = ["i","c","o","n","_","t","c","_","w","a","r"]
fileprivate let noti_messageStr:String = "value"

/*: "Live Warning" :*/
fileprivate let dataSuccessStr:[Character] = ["L","i","v","e"," ","W","a","r","n"]
fileprivate let const_pathResultName:[Character] = ["i","n","g"]

/*: "OK" :*/
fileprivate let const_atUrl:String = "videoK"

/*: "Violation Reason: " :*/
fileprivate let dataCellMessage:[Character] = ["V","i","o","l","a","t","i","o"]
fileprivate let notiPlayPath:[Character] = ["n"," ","R"]
fileprivate let dataCollectionName:String = "eason: make image to pop"

/*: "Warning Time: " :*/
fileprivate let showMakeValue:String = "Warncell period"
fileprivate let main_itemKey:String = "card view else message dataTime"
fileprivate let data_sizeLabKey:[Character] = [":"," "]
...
class SubThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showWithFormat.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.thoughtImageBundleSizeText(name: (String(appToStarValue) + noti_messageStr.replacingOccurrences(of: "value", with: "n")))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.text = (String(dataSuccessStr) + String(const_pathResultName)).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(thimble), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension SubThen {
    ...
    func ritualImage(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.readRemove()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(dataCellMessage) + String(notiPlayPath) + String(dataCollectionName.prefix(7))).localized
        ...
        var timeText = (String(showMakeValue.prefix(4)) + "ing " + String(main_itemKey.suffix(4)) + String(data_sizeLabKey)).localized
