...
fileprivate let kRegularStr:[UInt8] = [0x37,0x3c,0x37,0x42,0xf6,0x31,0x3d,0x32,0x33,0x40,0x8,0xf7,0xee,0x36,0x2f,0x41,0xee,0x3c,0x3d,0x42,0xee,0x30,0x33,0x33,0x3c,0xee,0x37,0x3b,0x3e,0x3a,0x33,0x3b,0x33,0x3c,0x42,0x33,0x32]

fileprivate func colorCell(index num: UInt8) -> UInt8 {
...
/*: "icon_mini_voice_end" :*/
fileprivate let showJawFormat:String = "self show extensionicon_mini"
fileprivate let dataStatusKey:String = "_voiview video video"
fileprivate let dataPicContent:String = "ce_endstring height"

/*: "#F95151" :*/
fileprivate let notiFeatureTimeStr:String = "#F95151file if"

/*: "End of call" :*/
fileprivate let appMomentToUrl:String = "Endraw string"
fileprivate let k_keyPushForText:[Character] = [" ","o","f"," ","c","a","l","l"]

/*: "img_home_shadow_icon" :*/
fileprivate let app_modelMsg:[Character] = ["i","m","g","_","h","o","m","e","_","s","h","a"]
fileprivate let appLabelTitle:[Character] = ["d","o","w","_","i","c","o","n"]
...
class FileMiniView: ShortListThen {
    // 小窗口通话状态
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kRegularStr.map{colorCell(index: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.thoughtImageBundleSizeText(name: (String(showJawFormat.suffix(9)) + String(dataStatusKey.prefix(4)) + String(dataPicContent.prefix(6))))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(notiFeatureTimeStr.prefix(7))))
        ...
        lab.text = (String(appMomentToUrl.prefix(3)) + String(k_keyPushForText)).localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.thoughtImageBundleSizeText(name: (String(app_modelMsg) + String(appLabelTitle)))
...
extension FileMiniView {
    /// 构建视频小窗口
    //: static func buildVideoMiniView() -> TalkingVideoMiniView {
    static func videoComment() -> FileMiniView {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = FileMiniView(frame: .zero)
