...
/*: "id" :*/
fileprivate let k_sharedName:String = "shared"
...
// __CLOSE_PRINT__
//
//  AvailableTransformableInfoModel.swift
//  AbroadTalking
//
...
struct AvailableTransformable: HandyJSON {
    //: var gid: String!
    var gid: String! // 礼物Id
    //: var price: Int = 0
...
struct SubMeasurable: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct SelectHandyJSON: HandyJSON {
