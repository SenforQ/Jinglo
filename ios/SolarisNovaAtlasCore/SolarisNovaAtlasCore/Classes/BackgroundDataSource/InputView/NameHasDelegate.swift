...
open class NameHasDelegate: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = NameHasDelegate.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func requestDown() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(telecastingChange),
    ...
    @objc private func telecastingChange() {
