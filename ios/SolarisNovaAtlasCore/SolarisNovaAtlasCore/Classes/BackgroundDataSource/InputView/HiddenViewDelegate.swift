...
fileprivate let app_floorContent:[UInt8] = [0x9e,0x99,0x9e,0x83,0xdf,0x94,0x98,0x93,0x92,0x85,0xcd,0xde,0xd7,0x9f,0x96,0x84,0xd7,0x99,0x98,0x83,0xd7,0x95,0x92,0x92,0x99,0xd7,0x9e,0x9a,0x87,0x9b,0x92,0x9a,0x92,0x99,0x83,0x92,0x93]

private func resultEmpty(color num: UInt8) -> UInt8 {
    return num ^ 247
}

/*: "#292929" :*/
fileprivate let app_frameStr:String = "path"
fileprivate let k_sizeKey:String = "2search2search2search"

/*: "9999999" :*/
fileprivate let user_makeId:[Character] = ["9","9","9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let k_modelFormat:String = "double typeicon_coi"
fileprivate let app_wayId:String = "origin"

/*: "icon_gift_more_arrow" :*/
fileprivate let appTopCheckNameId:[Character] = ["i","c","o","n","_","g","i","f","t"]
fileprivate let showPlayerMsg:[Character] = ["_","m","o","r","e","_","a","r","r","o","w"]

/*: "Hot" :*/
fileprivate let k_numberContent:[Character] = ["H","o","t"]

/*: "VIP" :*/
fileprivate let user_titlePath:[Character] = ["V","I","P"]

/*: "Bags" :*/
fileprivate let app_userName:String = "Bagsmini equal self"

/*: "icon_gift_num_arrow" :*/
fileprivate let userPathData:String = "equal selectedicon_g"
fileprivate let k_worldName:String = "bottom elsenum_arrow"

/*: "Send" :*/
fileprivate let showMagnitudeeractionImageMessage:[Character] = ["S","e","n","d"]

/*: "nav_back_black_nor" :*/
fileprivate let k_bottomFormat:String = "attach min lab pair insidenav_ba"
fileprivate let show_feedFormat:String = "ack_noself text in"
fileprivate let app_shareKey:String = "size"

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let showOfFormat:[UInt8] = [0x9d,0xb1,0xae,0x69,0xb7,0xbe,0xb6,0xab,0xae,0xbb,0x69,0xb8,0xaf,0x69,0xb0,0xb2,0xaf,0xbd,0xbc,0x69,0xac,0xaa,0xb7,0xb7,0xb8,0xbd,0x69,0xab,0xae,0x69,0xb5,0xae,0xbc,0xbc,0x69,0xbd,0xb1,0xaa,0xb7,0x69,0x7a]

fileprivate func buttonAction(top num: UInt8) -> UInt8 {
...
fileprivate let showById:String = "Pleacount extra path"
fileprivate let constTableName:String = "player"
fileprivate let constViewMsg:String = "title ifct a "

/*: "Please select an object" :*/
fileprivate let kConstraintMsg:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c"]
fileprivate let main_locationMessage:[Character] = ["t"," ","a","n"," ","o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let main_liveStr:[UInt8] = [0x45,0x73,0x7a,0x73,0x75,0x62,0x36,0x62,0x7e,0x73,0x36,0x72,0x73,0x65,0x7f,0x64,0x73,0x72,0x36,0x71,0x7f,0x70,0x62,0x36,0x62,0x79,0x36,0x63,0x78,0x7a,0x79,0x75,0x7d]

private func mKey(view num: UInt8) -> UInt8 {
    return num ^ 22
}

/*: "OK" :*/
fileprivate let k_layerName:[Character] = ["O","K"]

/*: "Select object >" :*/
fileprivate let dataReasonButtonStr:[Character] = ["S","e","l","e","c","t"," ","o","b","j"]
fileprivate let mainWindowVideoData:String = "with value in size hiddenect >"

/*: "It looks like there's nothing" :*/
fileprivate let data_labKey:String = "It loindex aspect location next app"
fileprivate let user_giftText:String = "like thmake layer extension app"
fileprivate let notiItemId:[Character] = ["e"]
fileprivate let app_fileId:String = "re\'s "

/*: "FF75A4" :*/
fileprivate let kCurrentData:String = "make75A4"

/*: "E570FF" :*/
fileprivate let constSectionName:[Character] = ["E","5","7","0","F"]
fileprivate let userThoughtData:String = "use"

/*: "Ask for" :*/
fileprivate let mainPlusAddName:String = "Ask forbreak space true frame"

/*: " Select %@ > " :*/
fileprivate let app_messageKey:[Character] = [" ","S","e","l","e","c","t"," ","%","@"," ",">"," "]

/*: "All Numbers" :*/
fileprivate let appIndicatorUrl:String = "All Nuas user"
fileprivate let noti_eventFormat:[Character] = ["m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let noti_contentTitle:String = "self touchView "
fileprivate let data_managerText:[Character] = ["i","l","e","d"," ","d","e","s","c","r","i","p","t","i","o","n"," ",">"]

/*: "\n" :*/
fileprivate let dataModeMsg:[Character] = ["\n"]

/*: "%.2f" :*/
fileprivate let constLabelFormat:String = "to let%.2f"

/*: "9999" :*/
fileprivate let show_normalAppMsg:String = "9999"

/*: "Custom" :*/
fileprivate let dataTotalimateFeatureScaleUrl:[Character] = ["C","u","s","t","o","m"]

/*: "mf_coin" :*/
fileprivate let data_clickBringMessage:String = "title will insert conversationmf_co"
fileprivate let data_atPath:[Character] = ["i","n"]

/*: "showBagsRed" :*/
fileprivate let constBindAppMsg:String = "image height segment if modelshowB"
fileprivate let appTargetStr:[Character] = ["a","g","s","R","e","d"]
...
typealias SendFunctionBlock = (_ giftModel: AvailableTransformable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: AvailableTransformable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: AvailableTransformable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: AvailableTransformable, _ num: String, _ model: SodalistSendMemberModel) -> Void
// 隐藏礼物面板Block
...
private let userBottomContent = 44.0
//: let GiftScrollContentView_H = 252.0
let userLogData = 252.0
//: private let pageControl_H = 7.0
private let userVideoId = 7.0
//: private let bottomView_H = 44.0
private let appTabUrl = 44.0

//: class TalkingChatGiftView: UIView {
class HiddenViewDelegate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = userBottomContent + userLogData + userVideoId + appTabUrl + k_netId
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [ClickMirrorPath]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = ClickMirrorPath.Hot
    ...
    init(frame: CGRect = .zero, style: RefOutputStream = .normal, titlesArr: [ClickMirrorPath] = [.Hot, .Vip, .Bags]) {
        ...
        if self.style == .party {
            ...
            contentHeight += userChangeKey
        }
        //: setupSubviews()
        dismissTotalSubviews()
        //: bindInteraction()
        skidSocial()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_floorContent.map{resultEmpty(color: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: notiKeyTitle, width: kQueryValue, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (app_frameStr.replacingOccurrences(of: "path", with: "#") + k_sizeKey.replacingOccurrences(of: "search", with: "9")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.areaRemoveRadiiAt(width: kQueryValue, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: AdministrativeDivisionReactiveCompatible = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: kQueryValue, height: userChangeKey)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = AdministrativeDivisionReactiveCompatible(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: kQueryValue, height: userBottomContent)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (app_frameStr.replacingOccurrences(of: "path", with: "#") + k_sizeKey.replacingOccurrences(of: "search", with: "9")))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: StartImageButton = {
        //: let btn = TalkingButton()
        let btn = StartImageButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.clickLarge(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((String(user_makeId)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.thoughtImageBundleSizeText(name: (String(k_modelFormat.suffix(8)) + app_wayId.replacingOccurrences(of: "origin", with: "n"))), for: .normal)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.thoughtImageBundleSizeText(name: (String(appTopCheckNameId) + String(showPlayerMsg)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.loadRgba(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.loadRgba(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(PublisherViewCell.self, forCellWithReuseIdentifier: PublisherViewCell.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: FieldFlowLayout = //: return hotGiftCollectionView.collectionViewLayout as! FieldFlowLayout
        hotGiftCollectionView.collectionViewLayout as! FieldFlowLayout
    //: }()
    ...
    private lazy var titleScrollView: ContriveView = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(k_numberContent)).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((String(user_titlePath)).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(app_userName.prefix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = MemorySegmentStyle()
        ...
        let scrollview = ContriveView(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(userBottomContent)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if MakeThen.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = PublisherReactiveCompatible.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = PublisherReactiveCompatible.widthState() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !NumberryReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var giftNumButton: StartImageButton = {
        ...
        btn.setImage(UIImage.thoughtImageBundleSizeText(name: (String(userPathData.suffix(6)) + "ift_" + String(k_worldName.suffix(9)))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(underToCancel), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.clickLarge(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.readRemove()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(showMagnitudeeractionImageMessage)).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(scamper), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: notiKeyTitle - CGFloat(keyborHeight) - 44, width: kQueryValue, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.thoughtImageBundleSizeText(name: (String(k_bottomFormat.suffix(6)) + "ck_bl" + String(show_feedFormat.prefix(6)) + app_shareKey.replacingOccurrences(of: "size", with: "r"))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.lineClick(color: .readRemove(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(showMagnitudeeractionImageMessage)).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.drawObserver(showMsg: String(bytes: showOfFormat.map{buttonAction(top: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.drawObserver(showMsg: (String(showById.prefix(4)) + "se sel" + constTableName.replacingOccurrences(of: "player", with: "e") + String(constViewMsg.suffix(5)) + "gift").localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.drawObserver(showMsg: (String(kConstraintMsg) + String(main_locationMessage)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = ClickMirrorPath(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.airt(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: AvailableTransformable = dataArr[index] as! AvailableTransformable
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.readRemove()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(messageBy(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(remark(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(giftNotification(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: main_liveStr.map{mKey(view: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(allRight), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(dataReasonButtonStr) + String(mainWindowVideoData.suffix(5))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.clickLarge(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(data_labKey.prefix(5)) + "oks " + String(user_giftText.prefix(7)) + String(notiItemId) + app_fileId + "nothing").localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.sinceNext(colors: [UIColor(hex: (kCurrentData.replacingOccurrences(of: "make", with: "FF")))!.cgColor, UIColor(hex: (String(constSectionName) + userThoughtData.replacingOccurrences(of: "use", with: "F")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.clickLarge(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(mainPlusAddName.prefix(7))).localized, for: .normal)
...
extension HiddenViewDelegate {
    /// 隐藏视图
    //: @objc func dismissView() {
    @objc func harvestMoonSend() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: notiKeyTitle, width: kQueryValue, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func tillSum() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: notiKeyTitle - self.contentHeight, width: kQueryValue, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func allRight() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = ClickMirrorPath(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.airt(dataType: dataType)
    ...
    @objc func viewClick() {
        ...
        meneView = RefSessionMenuView(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func wood() {
        //: dismissView()
        harvestMoonSend()
        //: RangePushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        RangePushManager.share.barOn(webViewType: .luckyBlindBox)
    }
...
extension HiddenViewDelegate {
    ...
    func requestTo(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.airt(dataType: self.currType) as! [AvailableTransformable]
            // 找到当前背包礼物索引，更新数量
            ...
            NumberryReactiveCompatible.share.ground(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.saddle(force: true)
        }
    }
}

// MARK: - WeltanschauungViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension HiddenViewDelegate: WeltanschauungViewDelegate {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func moveListModel(model: SodalistSendMemberModel) {
        //: self.chatRoomgiftSelectedMemberModel = model
        self.chatRoomgiftSelectedMemberModel = model
        //: seleteObjectBtn.setTitle(" Select %@ > ".localizedArguments(model.nickname), for: .normal)
        seleteObjectBtn.setTitle((String(app_messageKey)).viewfinder(model.nickname), for: .normal)
    }
    ...
    func equalRescue() {
        ...
        if model.nickname == (String(appIndicatorUrl.prefix(6)) + String(noti_eventFormat)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! SodalistSendMemberModel
    ...
    func offUse(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(noti_contentTitle.suffix(5)) + "deta" + String(data_managerText)).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension HiddenViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func airt(dataType: ClickMirrorPath) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return NumberryReactiveCompatible.share.hetUpViewStatus(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func clickLoad() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return NumberryReactiveCompatible.share.ofItems()
    }
    ...
    func upWill(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == BlockRelatableTarget.myStery.rawValue)
        }
        ...
        hotGiftLayout.hotDataArr = airt(dataType: .Hot)
        //: hotGiftLayout.vipDataArr = getGiftData(dataType: .Vip)
        hotGiftLayout.vipDataArr = airt(dataType: .Vip)
        //: hotGiftLayout.bagsDataArr = getGiftData(dataType: .Bags)
        hotGiftLayout.bagsDataArr = airt(dataType: .Bags)
    ...
    @objc fileprivate func messageBy(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (show_normalAppMsg.capitalized)
            //: } else {
        } else {
    ...
    @objc func giftNotification(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: notiKeyTitle - CGFloat(keyborHeight) - 44, width: kQueryValue, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func remark(notification _: NSNotification) {
    ...
    @objc func verbalize() {
        ...
        if payWinType == 1 { // 半屏充值页
            //: RangePushManager.share.func__pushToHalfWebVC(webViewType: .RechargeHalfPage)
            RangePushManager.share.isoclinicEvent(webViewType: .RechargeHalfPage)
    ...
    func isochronous() {
        ...
        let sendingItems = clickLoad()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(mutual(index: i))
//            let giftNumArrModel: SubMeasurable = sendingItems[i] as! SubMeasurable
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(dataTotalimateFeatureScaleUrl)).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.TopConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = AvailableViewDelegate.upArray(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func now() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? PublisherViewCell
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.viewToMagnitude(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = ClickMirrorPath(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = airt(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = PublisherViewCell.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! PublisherViewCell
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = ClickMirrorPath(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = airt(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: AvailableTransformable = dataArr[indexPath.row] as! AvailableTransformable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.sizeSquareManager(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.fill(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = ClickMirrorPath(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = airt(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == BlockRelatableTarget.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == BlockRelatableTarget.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == BlockRelatableTarget.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                moveClick(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = itemNum(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = conkIndex(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            moveClick(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: PublisherViewCell = giftSelectedModel.lastHotCell as! PublisherViewCell
                //: cell.setChecked(checked: false)
                cell.fill(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: PublisherViewCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! PublisherViewCell
            //: currentCell.setChecked(checked: true)
            currentCell.fill(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.toDetail(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.airt(dataType: self.currType)
    ...
    func saddle(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + kQueryValue
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < kQueryValue ? kQueryValue : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / kQueryValue - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(kQueryValue) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = ClickMirrorPath.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = NumberryReactiveCompatible.share.page(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.targetAnimate(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && PunctuateThen.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == ClickMirrorPath.Hot && self.style == .normal && PunctuateThen.share.loginUserMode.sex == TopComparable.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == BlockRelatableTarget.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                offUse(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func all() {
        ...
        self.giftSelectedModel = SelectHandyJSON()
...
extension HiddenViewDelegate: LightViewDelegate {
    ...
    func moveClick(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.style(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.hadith(view: self.window!)
    ...
    func mutual(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: SubMeasurable = sendingItems[index] as! SubMeasurable
    ...
    func conkIndex(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > clickLoad().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension HiddenViewDelegate {
    ...
    private func dismissTotalSubviews() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: kQueryValue, height: notiKeyTitle - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(harvestMoonSend)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(userLogData)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(kQueryValue)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(kQueryValue - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(userVideoId)
    ...
    private func skidSocial() {
        //: PunctuateThen.share.loginUserMode.rx
        PunctuateThen.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(data_clickBringMessage.suffix(5)) + String(data_atPath)))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.upWill(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        NumberryReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(constBindAppMsg.suffix(5)) + String(appTargetStr)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                NumberryReactiveCompatible.share.messageMatch(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: PunctuateThen.share.loginUserMode.mf_coin)
                    self.upWill(needReload: true, mf_coin: PunctuateThen.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
